    ...
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative">
          <FaLayerGroup className="absolute left-4 top-3 text-gray-300 text-sm pointer-events-none" />
          <select
            name="filterKategori"
            value={dataForm.filterKategori}
            onChange={handleChange}
            className="appearance-none bg-white border border-secondary rounded-2xl pl-10 pr-8 py-2.5 text-sm font-medium outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 transition-all text-gray-600 cursor-pointer"
          >
            {kategoriList.map(k => (
              <option key={k} value={k}>{k}</option>
            ))}
          ...
          {/* Chevron */}
          <div className="absolute right-3 top-3 pointer-events-none text-gray-300 text-xs">▾</div>
        </div>

        {/* Filter Status */}
        <div className="relative">
          <FaCheckCircle className="absolute left-4 top-3 text-gray-300 text-sm pointer-events-none" />
          <select
            name="filterStatus"
